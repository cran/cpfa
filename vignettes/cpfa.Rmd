...
three components worked for classification purposes. We also examine, averaged 
across train-test splits, optimal tuning parameters. Note that **glmnet** 
...
several real datasets. See here for more information: 
...
As shown, classification accuracy is highest for the three-component RF 
...
information: <https://github.com/matthewasisgress/multiway-classification/>.
...
example above highlights the use of **cpfa** and three of its functions. For 
